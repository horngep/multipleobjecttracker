function [ noBubArray_HERB,BWList ] = PP_HERB( mser_param, vidNo )
%   Preprocessing: Histogram Equalisation + Remove Background
...
noBubArray_HERB = zeros(1,64); % create number of bubbles matrix
