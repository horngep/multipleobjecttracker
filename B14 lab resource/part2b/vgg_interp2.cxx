...
// $Id: vgg_interp2.cxx,v 1.34 2008/03/03 22:37:37 ojw Exp $
...
static inline mxArray *mxCreateUninitializedArray(mwSize ndim, const mwSize *dims, mxClassID classid, mxComplexity ComplexFlag)
{
    mxArray *outPtr = mxCreateNumericMatrix(0, 0, classid, ComplexFlag);
    mwSize nBytes = mxGetElementSize(outPtr);
...
template<class Method> static inline void wrapper_func(void *B, const void *A, const double *X, const double *Y, const int num_points, const int w, const int h, const int col, const double oobv, const mxClassID out_class, const mxClassID in_class);
template<class Method, class T> static inline void wrapper_func2(void *B, const T *A, const double *X, const double *Y, const int num_points, const int w, const int h, const int col, const double oobv, const mxClassID out_class);
template<class T, class U> static inline void interp_func(interp_nearest *, U *B, const T *A, const double *X, const double *Y, const int num_points, const int w, const int h, const int col, const U oobv);
template<class T, class U> static inline void interp_func(interp_linear *, U *B, const T *A, const double *X, const double *Y, const int num_points, const int w, const int h, const int col, const U oobv);
template<class T, class U> static inline void interp_func(interp_cubic *, U *B, const T *A, const double *X, const double *Y, const int num_points, const int w, const int h, const int col, const U oobv);
